...
if (isset($_SESSION['user']))
    { 
    ?>
    <li><a id="lg" href="#" onclick="$('#cart').slideUp();$('#login').slideToggle();">Hi, <?php echo $_SESSION['user'];?></a></li>
      <li><a href="#" onclick="$('#login').slideToggle();$('#cart').slideUp();">Settings</a></li>
      <li><a href="#" onclick="$('#login').slideUp();$('#cart').slideToggle();">Cart <span class='label label-danger bill'>Rs. <?php echo $_SESSION['bill']; ?></span></a></li>
    </ul>
  </div>
         <div id="bar">
...
<?php 
     ...
     {
    ?>
      <li><a id="lg" href="#" onclick="$('#Register').slideUp();$('#cart').slideUp();$('#login').slideToggle(); $('#u').focus();">Login</a></li>
      <li><a href="#" onclick="$('#login').slideUp();$('#cart').slideUp();$('#Register').slideToggle(); $('#rn').focus();">Register</a></li>
      <li><a href="#" onclick="$('#Register').slideUp();$('#login').slideUp();$('#cart').slideToggle();">Cart <span class='label label-danger bill'>Rs. <?php echo $_SESSION['bill']; ?></span></a></li>
    </ul>
  </div>
         <div id="bar">
             <?php $i = array('default','primary','success','info','warning','danger'); shuffle($i);?>
